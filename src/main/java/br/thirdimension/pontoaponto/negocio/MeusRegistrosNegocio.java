...
public class MeusRegistrosNegocio {
    ...
    public List<RegistrosDto> buscarListaDeRegistrosFiltrada(Long dataInicialLong, Long dataFinalLong, PageRequest pageRequest) throws PesquisarException{
        List<RegistrosDto> meusRegistrosDto = new ArrayList<>();
        Page<Registros> meusRegistros = null;
...
*/
    ...
    private List<RegistrosDto> converterEntidadeRegistrosParaDto(List<Registros> registros) {
        ...
        for(Registros registro : registros){
            ...
            registrosDiaDto = converterListaRegistroDiaParaDto(registro.getRegistroDia());
    ...
    private List<RegistroDiaDto> converterListaRegistroDiaParaDto(List<RegistroDia> registrosDia){
