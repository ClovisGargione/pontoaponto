 ...
 */
public class CredenciaisDoUsuarioDto {
    ...
    public CredenciaisDoUsuarioDto() {
        super();
    }

    public CredenciaisDoUsuarioDto(Long id, @NotEmpty String nome, @NotEmpty String email, @NotEmpty String senha, @NotEmpty String confirmacaoSenha, @NotEmpty String pis, @NotEmpty int horas, @NotEmpty int minutos, Integer saldoHoras, Integer saldoMinutos, boolean saldoPositivo) {
        super();
        this.id = id;
        this.nome = nome;
        this.email = email;
    ...
    public Integer getSaldoMinutos() {
        return saldoMinutos;
    }

    public void setSaldoMinutos(Integer saldoMinutos) {
        this.saldoMinutos = saldoMinutos;
    }
