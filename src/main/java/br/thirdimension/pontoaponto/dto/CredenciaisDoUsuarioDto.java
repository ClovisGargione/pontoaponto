...
public class CredenciaisDoUsuarioDto {
    ...
    public CredenciaisDoUsuarioDto(Long id, @NotEmpty String nome, @NotEmpty String email, @NotEmpty String senha, @NotEmpty String confirmacaoSenha, @NotEmpty String pis, @NotEmpty int horas, @NotEmpty int minutos) {
        super();
        this.id = id;
        this.nome = nome;
        this.email = email;
