 ...
 */
public class GraficoParametros {
    ...
    public GraficoParametros(List<String> labels, List<String> datasetsLabel, List<Integer> datasetsData, List<String> dataBackgroundColor, List<String> dataBorderColor) {
        this.labels = labels;
